...
## Web
### BookShop
پروژه وب تمرینی سایت فروشگاهی کتب کمک آموزشی با فرانت‌اند مدرن، بک‌اند (flask) و دیتابیس اطلاعات.
...
---
### PhoenixRestaurant 
لندینگ پیچ تمرینی برای رستوران فرضی با ساختار ماژولار فرانت‌اند
...
# نکته
لطفاً قبل قضاوت درباره سطح پروژه‌ها، مخزن ها را مشاهده نمایید.
